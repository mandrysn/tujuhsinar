                      ...
                      <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" required>
                                ...
                                <option value="1" {{ $tampil->type == 1 ? "selected" : "" }}>Hitung Meter</option>
                                <option value="2" {{ $tampil->type == 2 ? "selected" : "" }}>Hitung Lembar</option>
                                <option value="3" {{ $tampil->type == 3 ? "selected" : "" }}>Hitung Pcs</option>
