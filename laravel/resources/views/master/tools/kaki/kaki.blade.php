...
<script type="text/javascript">
    jQuery(document).on('change','#pelanggan_indoor', function(e){
		...
		jQuery.ajax({
			...
			{
				console.log(data)
				jQuery('.listKaki').remove();
				var tablaDatos = jQuery('#kaki_indoor');
				
					jQuery(data).each(function(key,value){
					    tablaDatos.append("<option class='listKaki' data-pid='"+value.id+"' value='"+value.id+"'>"+value.nama_kaki+" - ["+value.tambahan_harga+"]</option>");
					});
