        ...
        <div class="widget-box">
            ...
            <div role="tabpanel"> 
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item active"><a class="nav-link" href="#merchant" aria-controls="merchant" role="tab" data-toggle="tab">Merchandise</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="merchant">
                        <form method="post" action="{{ route('harga.merchantUpdate') }}" >
                            <div id="merchant_show" class="row col-md-12">
                                {!! csrf_field() !!}
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="barang_id" id="input_ds" required="">
                ...
                <table id="example0" class="table display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $detail->disc }} %</td>
                            <td>
                                <form action="{{ route('harga.merchantDestroy', $detail->id) }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
