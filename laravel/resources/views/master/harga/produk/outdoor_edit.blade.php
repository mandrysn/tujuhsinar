        ...
        <div class="widget-box">
            ...
            <div role="tabpanel"> 
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item active"><a class="nav-link" href="#outdoor" aria-controls="outdoor" role="tab" data-toggle="tab">Outdoor</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="outdoor">
                        <form method="post" action="{{ route('harga.outdoorUpdate') }}" >
                            <div id="outdoor_show" class="row col-md-12">
                                ...
                                <div class="col-md-12 col-lg-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="disc" id="input_kn" value="0" min="0" max="100" placeholder="%" required>
                                    </div>
                                </div>
