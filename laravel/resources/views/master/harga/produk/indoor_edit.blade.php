        ...
        <div class="widget-box">
            ...
            <div role="tabpanel"> 
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item active"><a class="nav-link" href="#indoor" aria-controls="indoor" role="tab" data-toggle="tab">Indoor</a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="indoor">
                        <form method="post" action="{{ route('harga.indoorUpdate') }}" >
                            <div id="flyer_show" class="row col-md-12">
                                {!! csrf_field() !!}
                ...
                <table id="example0" class="table display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $detail->disc }} %</td>
                            <td>
                                <form action="{{ route('harga.indoorDestroy', $detail->id) }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
