		...
		<div class="row"> 
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<a href="{{ route('member.create') }}" class="btn btn-default"><i class="fa fa-plus-circle"></i>Tambah Member</a>
					<br>
					<br>
								...
								<tr>
									...
									<td>
										<form action="{{ route('member.destroy', $datas->id) }}" method="post">
											{{ csrf_field() }}
											{{ method_field('DELETE') }}
										<a href="{{ route('member.edit', $datas->id) }}" class="btn btn-option2"><i class="fa fa-info"></i>Edit</a>
