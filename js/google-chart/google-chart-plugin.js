function drawChart() {
    ...
    var a = {
        ...
        n = new google.visualization.ColumnChart(document.getElementById("gchart_col_1"));
    n.draw(e, a);
    var n = new google.visualization.ColumnChart(document.getElementById("gchart_col_2"));
    n.draw(e, a);
    var e = new google.visualization.DataTable;
    e.addColumn("number", "Day"), e.addColumn("number", "Guardians of the Galaxy"), e.addColumn("number", "The Avengers"), e.addColumn("number", "Transformers: Age of Extinction"), e.addRows([
        [1, 37.8, 80.8, 41.8],
        [2, 30.9, 69.5, 32.4],
        [3, 25.4, 57, 25.7],
        [4, 11.7, 18.8, 10.5],
    ...
    var e = google.visualization.arrayToDataTable([
        ...
        n = new google.visualization.PieChart(document.getElementById("gchart_pie_1"));
    n.draw(e, a);
    var a = {
            pieHole: .4
        },
        n = new google.visualization.PieChart(document.getElementById("gchart_pie_2"));
    n.draw(e, a);
    var e = new google.visualization.DataTable;
    e.addColumn("string", "Task ID"), e.addColumn("string", "Task Name"), e.addColumn("string", "Resource"), e.addColumn("date", "Start Date"), e.addColumn("date", "End Date"), e.addColumn("number", "Duration"), e.addColumn("number", "Percent Complete"), e.addColumn("string", "Dependencies"), e.addRows([
    ...
    var a = {
        ...
        n = new google.visualization.GanttChart(document.getElementById("gchart_gantt"));
    n.draw(e, a)
}
